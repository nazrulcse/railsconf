        ...
        if (windowWidth > 767) {
            $(window).on('scroll', function () {
                if ($(window).scrollTop() > 80) {
                    $('.main-nav').addClass('fixed-menu animatedx custom-animated slideInDown');
                } else {
                    $('.main-nav').removeClass('fixed-menu animatedx custom-animated slideInDown');
                }
            });
        } else {
            $('.main-nav').addClass('fixed-menu animatedx custom-animated slideInDown');
...
(function () {
    ...
    var styles = [{"featureType": "road", "stylers": [{"color": "#b4b4b4"}]}, {
        "featureType": "water",
